...
<div class="col-lg-12" style="padding: 0 5% 0">
    <div class="row mb-3">
        ...
        @include('perito.laudo.materiais.attributes.tambor', ['tambor_rebate2' => $revolver->tambor_rebate ??
        old('tambor_rebate')])
        @include('perito.laudo.materiais.attributes.capacidade_tambor', ['capacidade_tambor' =>
        $revolver->capacidade_tambor ?? old('capacidade_tambor')])
