...
<div class="col-lg-12" style="padding: 0 5% 0">
    <div class="row mb-3">
        ...
        @include('perito.laudo.materiais.attributes.carregamento', ['carregamento2' => $pistola->carregamento ??
        old('carregamento')])
        @include('perito.laudo.materiais.attributes.cao', ['cao2' => $pistola->cao ?? old('cao')])
        @include('perito.laudo.materiais.attributes.carregador', ['carregador2' => $pistola->carregador ??
        old('carregador')])
        ...
        $pistola->retem_carregador ?? old('retem_carregador')])
        @include('perito.laudo.materiais.attributes.trava_ferrolho', ['trava_ferrolho2' => $pistola->trava_ferrolho ??
        old('trava_ferrolho')])
        @include('perito.laudo.materiais.attributes.trava_gatilho', ['trava_gatilho2' => $pistola->trava_gatilho ??
        old('trava_gatilho')])
        @include('perito.laudo.materiais.attributes.trava_seguranca', ['trava_seguranca2' => $pistola->trava_seguranca
        ?? old('trava_seguranca')])
