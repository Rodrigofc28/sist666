...
<div class="col-lg-12" style="padding: 0 5% 0">
    <div class="row mb-3">
        ...
        $garrucha->disposicao_canos ?? old('disposicao_canos')])
        @include('perito.laudo.materiais.attributes.teclas_gatilho', ['teclas_gatilho2' => $garrucha->teclas_gatilho ??
        old('teclas_gatilho')])
        ...
        @include('perito.laudo.materiais.attributes.placas_laterais', ['placas_laterais2' => $garrucha->placas_laterais
        ?? old('placas_laterais')])
        @include('perito.laudo.materiais.attributes.chave_abertura', ['chave_abertura2' => $garrucha->chave_abertura ??
        old('chave_abertura')])
