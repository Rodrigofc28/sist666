...
{!! Html::script('js/habilitalacremunicao.js') !!}
@endsection
...
<input type="hidden" name="municao_de" id="laudo_id" value="arma longa">
...
<div class="col-lg-12" style="padding: 0 5% 0">
    <div class="row mb-3">
        ...
        @include('perito.laudo.materiais.attributes.projetil_arma_longa', ['projetil2' => $municao->projetil ??
        old('projetil')])
        ...
        old('funcionamento')])
        @include('perito.laudo.materiais.attributes.lacrecartucho', ['lacrecartucho' => $municao->lacrecartucho ??
        old('lacrecartucho')])
