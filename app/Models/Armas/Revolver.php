...
class Revolver extends Model
{
    public static function text($arma)
    {
        ...
        $fim = "Observação: O revólver acima descrito devidamente identificado com o lacre nº $arma->num_lacre, permanecerá sob custódia da POLÍCIA CIENTÍFICA DO PARANÁ.";
